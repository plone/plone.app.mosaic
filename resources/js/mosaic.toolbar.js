                                        ...
                                        for (y in action.items[z].items) {
                                            elm.append(
                                                $(document.createElement("option"))
                                                    .attr(
                                                        "value",
                                                        action.items[z].items[y].value
                                                    )
                                                    .addClass(
                                                        "mosaic-option mosaic-option-" +
                                                            normalizeClass(
                                                                action.items[z].items[y]
                                                                    .value
                                                            )
                                                    )
...
$.fn.mosaicToolbar = function () {
    ...
    return this.each(function () {
        ...
        SelectedTileChange = function () {
            // Local variables
            var obj, tiletype, actions, x, tile_group, y;
