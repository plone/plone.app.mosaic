...
// Define UI templates
$.mosaic.selectLayoutTemplate = _.template(
    "<div>" +
        "<h1>Select Layout</h1>" +
...
$.mosaic.saveLayoutTemplate = _.template(
    "<div>" +
        "<h1>Save Layout</h1>" +
...
$.mosaic.manageLayoutsTemplate = _.template(
    "<div>" +
...
$.mosaic.deleteLayoutTemplate = _.template(
    "<div>" +
        "<h1>Delete layout</h1>" +
...
var _hasCustomLayouts = function () {
    ...
    return (
        _.filter($.mosaic.options.available_layouts, function (layout) {
...
$.mosaic._deleteLayout = function (layout, existing, callback) {
    ...
    var modal = new Modal($el, {
        html: $.mosaic.deleteLayoutTemplate(
            $.extend(
                {},
                true,
                {
                    ...
                    selected:
                        $.mosaic.getSelectedContentLayout() ===
    ...
    modal.on("shown", function () {
        $(".delete-layout", modal.$modal)
            ...
            .on("click", function (e) {
                ...
                _.each(
                    $.mosaic.options.available_layouts.concat(
                        $.mosaic.options.user_layouts
                    ),
                    function (l) {
                        if (l.path === layout_id) {
                            return $.mosaic.deleteLayout(l, function (data) {
                                ...
                                // reload it...
                                $.mosaic.options.available_layouts =
...
$.mosaic.selectLayout = function (initial) {
    ...
    var $el = $("<div/>").appendTo("body");
    var modal = new Modal($el, {
        html: $.mosaic.selectLayoutTemplate(
            $.extend(
                {},
                true,
                {
...
$.mosaic.saveLayout = function (initial) {
    var $el = $("<div/>").appendTo("body");
    var modal = new Modal($el, {
        html: $.mosaic.saveLayoutTemplate(
            $.extend(
                {},
                true,
                {
