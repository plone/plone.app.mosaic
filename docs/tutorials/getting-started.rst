...
3.  Select a **Text** tile from the **Structure** category. It will appear as a draggable box.
4.  Drag the tile to a new position on the page. Notice how potential drop zones highlight as you move.
...
*   Learn how to reuse this design by reading :ref:`how_to_save_custom_layout`.
